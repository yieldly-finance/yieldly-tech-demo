...
${gcmd} app call --app-id $APPID --app-account=$ESCROW --app-arg "str:W" --from $ACCOUNT  --out=txn1.tx
${gcmd} asset send -a 2000000000 -f ${ESCROW} -t ${ACCOUNT}  --assetid ${ASSETID} --fee=1000 --out=txn2.tx
