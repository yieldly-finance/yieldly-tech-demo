...
${gcmd} app call --app-id $APPID --app-arg "str:S" --from=$ACCOUNT  --out=txn1.tx
${gcmd} asset send -a 1000000000 -f ${ACCOUNT} -t ${ESCROW}  --creator ${ACCOUNT} --assetid $ASSETID --out=txn2.tx
